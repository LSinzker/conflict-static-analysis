...
public class ArrayWithTransitivityOneConflictTest {
    ...
    public void configure() {
        ...
        AbstractMergeConflictDefinition definition = new AbstractMergeConflictDefinition() {
            ...
            protected Map<String, List<Integer>> sourceDefinitions() {
                ...
                lines.add(7);
                res.put("br.unb.cic.analysis.samples.ArrayWithTransitivitySample", lines);
                return res;
            }
        ...
        String targetClass = "br.unb.cic.analysis.samples.ArrayWithTransitivitySample";
